...
char **strtow(char *str)
{
	...
	if (str == NULL || str[0] == 0)
		return (NULL);
OBOBOB	words = word_counter(str);
	if (words < 1)
OBOBOB		return (NULL);
OAOAOAOAOAOAOAOAOAOAOAOAOAOAOAOAOAOA	strDup = malloc(sizeof(char *) * (words + 1));
	if (strDup == NULL)
		return (NULL);
	i = 0;
	while (i < words && *str != '\0')
	{
		...
		str++;
OBOBOB	}
OBOBOBOBOBOB	strDup[i] = '\0';
OBOBOB	return (strDup);
}
